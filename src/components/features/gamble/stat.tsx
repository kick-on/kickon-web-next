...
export default function Stat() {
	...
	return (
		<div className="grid grid-cols-[1fr_auto] gap-2.5 rounded-[0.625rem] border border-black-200 p-4">
			<div className="pr-2.5">
				<div className="body4-medium mb-1">나의 예측 성공률</div>
				<div className="body7-regular text-black-500 mb-4">지금까지 누적된 예측 성공률 기준</div>

				<div
					className="relative w-31 aspect-square rounded-full mx-auto
				...
				<div className="grid grid-cols-3 gap-2.5">
					{miniBoxes.map((box) => (
						<div key={box.label} className="w-[7.625rem] p-3 pb-2.5 bg-black-100 border border-black-200 rounded-lg">
							...
							<div className="display-semibold text-primary-900 text-right">
								{box.value}
