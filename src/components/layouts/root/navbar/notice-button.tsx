...
export default function NoticeButton() {
	...
	return (
		<div className="relative w-fit h-full items-center flex">
			<button aria-label={'알림'} onClick={handleNoticeIconClick} className="relative w-6 h-6 @mobile:w-5 @mobile:h-5">
				<Image aria-hidden={true} src={iconSrc} alt="" width={24} height={24} />
